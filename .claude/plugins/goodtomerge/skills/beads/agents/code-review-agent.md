...
npx tsx scripts/beads-prime.ts --work-type review --files "<changed-files>" --keywords "testing" "quality"
```
...
**File**: `src/app/api/auth/route.ts:34`
...
**File**: `src/app/api/auth/route.ts:12-25`
