...
{"issue_number": 123, "epic_id": "goodtomerge-abc", "worktree": "agent-1", "orchestrator_pid": 12345, "status": "active", "started_at": "2026-01-09T10:00:00Z"}
{"issue_number": 456, "epic_id": "goodtomerge-def", "worktree": "agent-2", "orchestrator_pid": 12346, "status": "active", "started_at": "2026-01-09T10:05:00Z"}
```
...
```bash
npx tsx scripts/beads-prime.ts --work-type planning --keywords "orchestration" "coordination" "worktree"
```
...
swarm:
  ...
  worktree_config:
    base_dir: "../goodtomerge-worktrees"
...
| ----- | ------------- | -------- | ------ | -------- |
| #123  | goodtomerge-abc | agent-1  | active | 2h 15m   |
| #456  | goodtomerge-def | agent-2  | active | 45m      |
