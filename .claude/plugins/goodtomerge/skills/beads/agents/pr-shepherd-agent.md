...
**Tools**: GitHub CLI, goodtomerge:pr-shepherd skill, BEADS CLI
...
This agent leverages the existing `goodtomerge:pr-shepherd` skill for the core PR monitoring logic. It adds BEADS integration for task tracking.

**See**: `.claude/plugins/goodtomerge/skills/pr-shepherd/SKILL.md` for detailed PR monitoring behavior.
...
## Integration with goodtomerge:pr-shepherd

The existing PR Shepherd skill handles:

| Responsibility             | Handled By                     |
| -------------------------- | ------------------------------ |
| CI monitoring              | goodtomerge:pr-shepherd          |
| Auto-fixing lint/types     | goodtomerge:pr-shepherd          |
| Review comment handling    | goodtomerge:handling-pr-comments |
| Thread resolution          | goodtomerge:handling-pr-comments |
| User prompts for decisions | goodtomerge:pr-shepherd          |
