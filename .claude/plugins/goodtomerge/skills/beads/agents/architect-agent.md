...
npx tsx scripts/beads-prime.ts --work-type planning --keywords "<feature-keywords>"

# If you know which files will be affected:
npx tsx scripts/beads-prime.ts --work-type planning --files "src/lib/services/*.ts" --keywords "<keywords>"
```
...
grep -r "<keyword>" src/app/api/ --include="*.ts" -l
...
│ - Auth checks with getServerSession                         │
└─────────────────────────────────────────────────────────────┘
                              ▼
┌─────────────────────────────────────────────────────────────┐
