...
See `goodtomerge:design-review-gate` skill for full details.
...
.claude/plugins/goodtomerge/skills/beads/agents/issue-orchestrator.md
...
```
.claude/plugins/goodtomerge/skills/beads/
├── SKILL.md                    # This file
└── agents/
...
.claude/plugins/goodtomerge/skills/design-review-gate/
└── SKILL.md                    # Design review gate orchestrator (NEW)

.claude/plugins/goodtomerge/skills/brainstorming-extension/
