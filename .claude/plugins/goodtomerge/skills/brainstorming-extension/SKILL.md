...
superpowers:brainstorming
    ...
    │  (goodtomerge:design-review-gate)         │
    │                                         │
    │  Spawns in parallel:                    │
...
### With goodtomerge:design-review-gate

Delegates the actual review work to the design-review-gate skill.

### With goodtomerge:beads-orchestration
...
- `goodtomerge:design-review-gate` - The review gate implementation
- `superpowers:writing-plans` - Used after approval for detailed plans
- `goodtomerge:beads-orchestration` - For creating epics and tracking work
