...
set -a && source /Users/dsifry/Developer/goodtomerge/.env && set +a
```
...
KEY=$(grep "^POSTHOG_READ_ONLY_KEY=" /Users/dsifry/Developer/goodtomerge/.env | cut -d'=' -f2)
...
1. Check the key exists in .env: `grep POSTHOG_READ_ONLY_KEY /Users/dsifry/Developer/goodtomerge/.env`
