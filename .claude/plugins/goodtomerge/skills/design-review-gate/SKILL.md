...
- `goodtomerge:beads-orchestration` - BEADS workflow this integrates with
...
- `.claude/plugins/goodtomerge/skills/beads/agents/product-manager-agent.md`
- `.claude/plugins/goodtomerge/skills/beads/agents/architect-agent.md`
- `.claude/plugins/goodtomerge/skills/beads/agents/designer-agent.md`
- `.claude/plugins/goodtomerge/skills/beads/agents/security-design-agent.md`
- `.claude/plugins/goodtomerge/skills/beads/agents/cto-agent.md`
