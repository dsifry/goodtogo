...
npx tsx scripts/beads-prime.ts --work-type research --keywords "<task-keywords>"
```
...
mcp__context7__query-docs --libraryId "/vercel/next.js" --query "<topic>"
...
| `src/app/api/related/route.ts` | Medium    | API pattern      |
...
cat src/app/api/example/route.ts
```
